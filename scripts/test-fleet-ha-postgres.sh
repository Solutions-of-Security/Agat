...
suffix="${$}-$(date +%s)"
postgres_container="agat-fleet-ha-postgres-${suffix}"
postgres_password="admin-fleet-ha-test"
migration_password="migration-fleet-ha-test"
system_password="system-fleet-ha-test"
tenant_password="tenant-fleet-ha-test"
...
AGAT_TEST_POSTGRES_URL="postgresql://agat_system:${system_password}@127.0.0.1:${postgres_port}/agat" \
AGAT_POSTGRES_TENANT_URL="postgresql://agat_tenant:${tenant_password}@127.0.0.1:${postgres_port}/agat" \
AGAT_TEST_POSTGRES_TENANT_URL="postgresql://agat_tenant:${tenant_password}@127.0.0.1:${postgres_port}/agat" \
AGAT_POSTGRES_SSL_MODE=disable \
AGAT_REGION=eu-test-1 \
AGAT_RESIDENCY_DOMAIN=eu-test \
