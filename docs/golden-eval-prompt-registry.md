...
В 0.9 [A2A adapter](./a2a-adapter.md) опубликовал только выбранную active-конфигурацию агента, а 1.0 закрыл [production hardening durable runtime](./production-durable-runtime.md) с replay gate и versioned rollout. Текущий рекомендуемый этап — risk-tier approvals и централизованный emergency deny.
