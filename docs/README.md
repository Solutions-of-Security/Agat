...
- Production PostgreSQL resilience: provider-neutral multi-AZ/PITR gate, schema v24 DR canaries, physical failover/restore rehearsal и HMAC-sealed RPO/RTO/SLO evidence.
