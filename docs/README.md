...
- Production PostgreSQL resilience: provider-neutral multi-AZ/PITR gate, DR canaries (introduced v22, current schema v25), physical failover/restore rehearsal и HMAC-sealed RPO/RTO/SLO evidence.
...
- Residency-aware region-loss DR: fully fenced whole-cell transition, aligned PostgreSQL/S3/Temporal recovery, four-eyes, snapshot-bound activation и monotonic write epoch без active-active writes.
